...
class QuotexAdapter(IDataSource):
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        super().__init__(config)
        self._connected = False
        logger.warning("QuotexAdapter is a skeleton and not yet fully implemented.")
    ...
    def get_server_timestamp(self) -> float:
        raise NotImplementedError("Quotex get_server_timestamp not implemented")

    def get_balance(self) -> float:
        raise NotImplementedError("Quotex get_balance not implemented")

    def start_stream(self, symbol: str, timeframe: str, count: int) -> None:
        raise NotImplementedError("Quotex start_stream not implemented")

    def connect(self) -> None:
        logger.warning("Quotex connect() not implemented - skeleton only")
        self._connected = True

    def disconnect(self) -> None:
        logger.warning("Quotex disconnect() not implemented - skeleton only")
        self._connected = False
