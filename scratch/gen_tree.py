...
def generate_tree(startpath, exclude_dirs={'node_modules', '__pycache__', '.git', '.venv', '.idea', '.vscode', 'logs', '__pycache__'}, exclude_exts={'.pyc', '.pyd', '.exe', '.dll', '.so', '.dylib'}, exclude_files={'*.pyc', '*.pyd'}):
    lines = []
