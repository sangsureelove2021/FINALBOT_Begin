...
def main():
    ...
    # 03/05/2026 from 01:00 to 23:00 ICT (Thai time)
    # Start: 2026-05-03 01:00:00 ICT = 2026-05-02 18:00:00 UTC
    # End: 2026-05-03 23:00:00 ICT = 2026-05-03 16:00:00 UTC
    start_dt = datetime(2026, 5, 2, 18, 0, tzinfo=timezone.utc)
    end_dt = datetime(2026, 5, 3, 16, 0, tzinfo=timezone.utc)
    ...
    print(f"🔄 Starting backtest on EURUSD-OTC for May 3, 2026...")
    ...
    # Save report
    report_path = PROJECT_ROOT / "docs" / "EURUSD_OTC_may_3_backtest_report.md"
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("# REPORT: EURUSD-OTC 1-Day Backtest (03/05/2026)\n")
    ...
    print(f"\n✅ Backtest completed. Report saved to: docs/EURUSD_OTC_may_3_backtest_report.md")
