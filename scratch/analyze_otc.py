...
def run_otc_simulation():
    print("="*80)
    print("FINALBOT OFFLINE BACKTEST SIMULATOR (EURUSD_OTC - SELECTIVE CHECKPOINTS)")
    print("="*80)
    ...
    print("Active Locks: ONLY Checkpoint 5 (Trap) & Checkpoint 10 (Extreme Vol)")
    ...
    # Setup Optimized Engine Registry
    ...
    # --- PRINT FINAL REPORT ---
    print("\n" + "="*80)
    print("BACKTEST SIMULATION RESULTS SUMMARY (EURUSD_OTC - SELECTIVE CHECKPOINTS: 5 & 10 ONLY)")
    print("="*80)
