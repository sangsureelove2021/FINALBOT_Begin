...
def main():
    ...
    # Thursday date: May 28, 2026
    # 11:00 to 23:00 GMT+7 = 04:00 to 16:00 UTC
    start_dt = datetime(2026, 5, 28, 4, 0, tzinfo=timezone.utc)
    end_dt = datetime(2026, 5, 28, 16, 0, tzinfo=timezone.utc)
    ...
    print("="*80)
    print("🚀 FINALBOT THURSDAY BACKTEST (EURUSD & EURUSD-OTC)")
    print("="*80)
    print(f"Date                : Thursday, 2026-05-28")
    ...
    print("\n" + "="*80)
    print("📊 THURSDAY BACKTEST SUMMARY REPORT")
    print("="*80)
