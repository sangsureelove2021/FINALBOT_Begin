...
def main():
    ...
    # Start: 2026-05-07 00:00:00 ICT = 2026-05-06 17:00:00 UTC
    # End: 2026-05-07 23:55:00 ICT = 2026-05-07 16:55:00 UTC
    ...
    print(f"🔄 Starting backtest on GBPUSD for May 7, 2026...")
    ...
    # Save report
    report_path = PROJECT_ROOT / "docs" / "GBPUSD_may_7_backtest_report.md"
    ...
    with open(report_path, "w", encoding="utf-8") as f:
        f.write("# REPORT: GBPUSD 1-Day Backtest (07/05/2026)\n")
    ...
    print(f"\n✅ Backtest completed. Report saved to: docs/GBPUSD_may_7_backtest_report.md")
