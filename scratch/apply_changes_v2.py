...
proposed_path = r"C:\Users\Administrator\.gemini\antigravity\brain\bf808087-316a-4062-af9c-a51da648c8ed\scratch\proposed_arbitration_v2.txt"

with open(json_path, "r", encoding="utf-8") as f:
    data = json.load(f)

# Read proposed decisions v2
decisions = {}
...
print(f"Successfully applied changes v2! Modified {modified_count} entries. Total NOTRADE: {notrade_count}. Total Kept: {kept_count}.")
