...
│   └── orchestrator/           # ไฟล์ Prompt Payload (.txt 100 บรรทัด) แยกตามคู่เงิน
...
sequenceDiagram
    ...
    D2->>Out: เขียนไฟล์ Prompt Payload (.txt 100 บรรทัด)
    deactivate D2
