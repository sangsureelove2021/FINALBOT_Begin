...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="toggle-list" style="max-height: 300px;">
                <table>
                    <thead>
                        <tr>
                            <th>Symbol</th>
                    ...
                    <tbody id="trade-history-body">
                        ...
                        <tr>
                            <td>EURUSD-OTC</td>
                            <td class="text-green">CALL</td>
                            <td class="text-green">WIN</td>
                            <td class="text-green">+25.50</td>
                            <td>14:35:12</td>
                        </tr>
                        <!-- Example Row 2 -->
                        <tr>
                            <td>EURGBP</td>
                            <td class="text-red">PUT</td>
                            <td class="text-red">LOSE</td>
                            <td class="text-red">-30.00</td>
                            <td>14:32:56</td>
                        </tr>
                        <!-- Example Row 3 -->
                        <tr>
