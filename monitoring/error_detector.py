...
class ErrorDetector:
    def __init__(self, log_dir: str = "logs/logs_data_feed/errors"):
    ...
    def scan_latest_log(self) -> None:
        ...
        log_files = glob.glob(os.path.join(self.log_dir, "error*.log*"))
        if not log_files:
            print("[-] No error log files found in logs/logs_data_feed/errors/")
            return
