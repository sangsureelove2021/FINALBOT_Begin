...
class TradeLogger:
    ...
    def __init__(self, logs_dir: str = "logs/logs_ai", indicator_store: Optional[Any] = None):
        """
        Args:
        ...
        # Setup process logs directory for indicator snapshots
        self.process_logs_dir = Path("logs/process")
    ...
    def save_indicator_payload(self, symbol: str) -> Optional[str]:
        """
        Alias for save_indicator_snapshot - maintains backward compatibility.
        ...
        Returns:
            Path to the saved file, or None if failed
        """
        return self.save_indicator_snapshot(symbol)
